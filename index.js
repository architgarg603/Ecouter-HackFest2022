...
// detect.addEventListener("click", showPred);
  var alanBtnInstance = alanBtn({
    key: "9c2cb89f72600c69f4051f849fa9c6232e956eca572e1d8b807a3e2338fdd0dc/stage",
    onCommand: function (commandData) {
      if (commandData.command === "goto") {
        if(commandData.type == 'features'){
          window.location.href = '/index.html#feature-container'
        }else if(commandData.type == 'team'){
          window.location.href = '/index.html#team-container'
        }else if(commandData.type == 'helpline'){
          window.location.href = '/index.html#kiran-container'
        }else if(commandData.type == 'FAQ'){
          window.location.href = '/index.html#frequently-asked-questions'
        }else if(commandData.type == 'home'){
